            ...
            <section className='bg-richblack-700'>
                ...
                gap-10 text-center text-white'>
                    <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                        ...
                        lg:w-[95%]'>Studynotion is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</p>
                    </header>
                ...
                text-richblack-500'>
                    ...
                    <div className='flex flex-col items-center gap-10 lg:flex-row justify-between'>
                        ...
                        <div className='my-24 flex lg:w-[50%] flex-col gap-10'>
                            ...
                            bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%] '>Our Founding Story</h1>
                    ...
                    <div className='flex flex-col items-center lg:gap-10 lg:flex-row justify-between'>
                        ...
                        <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                            ...
                            text-4xl font-semibold text-transparent lg:w-[70%] '>Our Vision</h1>
