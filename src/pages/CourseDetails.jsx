...
const CourseDetails = () => {
    ...
    useEffect(() =>{
        const getFullCourseDetails = async () => {
            try {
                ...
                // console.log('getFullCourseDetails is : ', result);
    ...
    const {_id: course_id, courseName, courseDescription, thumbnail, price, whatYouWillLearn,
    courseContent, ratingAndReviews, instructor, studentsEnrolled, createdAt} = courseData;

    // console.log("courseData aaya hai: ", courseName);
            ...
            <div className={`relative w-full bg-richblack-800`}>
                <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
                    ...
                    py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
                        ...
                        <div className="flex w-full flex-col gap-4 border-y border-y-richblack-500 
                        py-4 lg:hidden">
                    ...
                    {/* Courses Card */}
                    <div className="right-[1rem] top-[60px] mx-auto hidden min-h-[600px] w-1/3 
...
//                             <>
//                             {
//                                 alreadyEnrolled ? <button onClick={()=>{navigate("/dashboard/enrolled-courses")}}  className='yellowButton'>Go to Course</button> : <button onClick={handlePayment} className='yellowButton'>Buy Now</button>
//                             }
//                             {
