...
const ExploreMore = () => {
    ...
    return (
        <div>
            ...
            <p className='text-center text-richblack-300 text-m text-[16px] mt-3'>
                    ...
                    tabsName.map( (element, index) => {
                        return (
                            <div className={`text-[13px] lg:text-[16px] flex flex-row items-center gap-2 
                                ...
                                text-center px-3 py-1 lg:px-7 lg:py-2`}
                                key={index}
            ...
            <div className='flex gap-9 w-full justify-center mt-5 flex-wrap lg:absolute right-0 
            left-0 mr-auto ml-auto'>
                {
