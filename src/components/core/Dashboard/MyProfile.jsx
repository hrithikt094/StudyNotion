...
const MyProfile = () => {
    ...
    return (
        <div className='mx-auto w-11/12 max-w-[1000px] py-10'>
            ...
            border-richblack-700 bg-richblack-800 p-3 md:p-8 md:px-12'>
                <div className='flex items-center gap-x-4'>
                    ...
                    <div className='space-y-1'>
                        ...
                        <p className=' text-[11px] md:text-sm text-richblack-300 md:max-w-full 
            ...
            {/* section 2 */}
            <div className='my-10 flex flex-col gap-y-3 md:gap-y-10 rounded-md border-[1px] 
            border-richblack-700 bg-richblack-800 p-3 md:p-8 md:px-12'>
