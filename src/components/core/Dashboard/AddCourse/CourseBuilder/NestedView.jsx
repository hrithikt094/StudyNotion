...
const NestedView = ({handleChangeEditSectionName}) => {
    ...
    const handleDeleteSection = async (sectionId) => {
        console.log("sectionId for deleting is: ", sectionId);
    ...
    const handleDeleteSubSection = async (subSectionId, sectionId) => {
        console.log("sectionId for deleting is: ", sectionId);
        console.log("subSectionId for deleting is: ", subSectionId);
                                ...
                                <div className="flex items-center gap-x-3">
                                    <button 
                                        onClick={() => handleChangeEditSectionName(
                                            section._id, section.sectionName
                                        )}
                                    >
                                    ...
                                    <BiSolidChevronDown className={`text-xl text-richblack-300`}/>
                                </div>
                            </summary>
