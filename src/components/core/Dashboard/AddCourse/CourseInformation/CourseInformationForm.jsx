...
const CourseInformationForm = () => {
    ...
    const onSubmit = async(data) => {
        ...
        // create a new course if we aren't editing it [creating new form for the first time]
        const formData = new FormData();
        formData.append("courseName", data.courseTitle);
        formData.append("courseDescription", data.courseShortDesc);
        formData.append("price", data.coursePrice);
        ...
        >
            ...
            <div className='flex flex-col space-y-2'>
                ...
                <div className='relative'>
                    ...
                    <HiOutlineCurrencyRupee className='absolute left-3 top-1/2 inline-block 
                    -translate-y-1/2 text-2xl text-richblack-400' />
                </div>
            ...
            <div className='flex flex-col space-y-2'>
                ...
                <select
                    ...
                    className='form-style w-full'
                >
                    <option value="" disabled> {/* disabled keeps it disabled from selecting */}
                        Choose a Category
                    </option>
            ...
            {/* Component for uploading a media and previewing it*/}
            <Upload
                name="courseImage"
