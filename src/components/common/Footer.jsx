    ...
    <div className="bg-richblack-800">
      ...
      text-richblack-400 leading-6 mx-auto relative py-14">
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          {/* Section 1 */}
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 
          pl-3 lg:pr-5 gap-3">
              ...
              FooterLink2.map((elements, index) => {
                return (
                  <div key={index} className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
                    ...
                    <div className="flex flex-col gap-2 mt-2">
                      {
                        elements.links.map((element, index) => {
                          return (
                            <div
                              key={index}
                              className="text-[14px] cursor-pointer hover:text-richblack-50 transition-all duration-200"
      ...
      mx-auto  pb-14 text-sm">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center">Made by Hrithik 🗿 © 2023 StudyNotion</div>
        </div>
      </div>
    </div>
  );
